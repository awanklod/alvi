...
echo -e "$RED╭═════════════════════════════════════════════════╮${NC}"
echo -e "$RED│${NC} ${COLBG1}           ${WH}• Add Vless Account •               ${NC} $RED│ $NC"
echo -e "$RED╰═════════════════════════════════════════════════╯${NC}"
echo -e ""
read -rp "User: " -e user
...
clear
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}• Premium Vless Account •${NC} $RED $NC" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}User         ${RED}: ${WH}${user}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}ISP          ${RED}: ${WH}$ISP" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}City         ${RED}: ${WH}$CITY" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Domain       ${RED}: ${WH}${domain}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Login Limit  ${RED}: ${WH}${iplim} IP" | tee -a /etc/vless/akun/log-create-${user}.log
if [ ${Quota} = '9999' ]; then
echo -ne
else
echo -e "$RED ${NC} ${WH}Quota Limit  ${RED}: ${WH}${Quota} GB" | tee -a /etc/vless/akun/log-create-${user}.log
fi
echo -e "$RED ${NC} ${WH}Port TLS     ${RED}: ${WH}443" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Port NTLS    ${RED}: ${WH}80,8080" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Port gRPC    ${RED}: ${WH}443" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}UUID         ${RED}: ${WH}${uuid}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Encryption   ${RED}: ${WH}none" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Network      ${RED}: ${WH}ws" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Path         ${RED}: ${WH}/vless" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Path grpc    ${RED}: ${WH}/vless-grpc" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${RED}Link Websocket TLS      ${WH}:${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED${NC}${WH}${vlesslink1}${NC}"  | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${RED}Link Websocket NTLS  ${WH}:${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED${NC}${WH}${vlesslink2}${NC}"  | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${RED}Link gRPC               ${WH}:${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED${NC}${WH}${vlesslink3}${NC}"  | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Format Openclash ${RED}: " | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}http://$domain:89/vless-$user.txt${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Expired Until   ${RED}: ${WH}$exp" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}    $author    " | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
...
cd
echo -e "$RED╭═════════════════════════════════════════════════╮${NC}"
echo -e "$RED ${NC}${COLBG1}            ${WH}• Trial Vless Account •             ${NC} $RED $NC"
echo -e "$RED╰═════════════════════════════════════════════════╯${NC}"
until [[ $timer =~ ^[0-9]+$ ]]; do
...
clear
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}• Trial Premium Vless Account •${NC} $RED $NC" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}User         ${RED}: ${WH}${user}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}ISP          ${RED}: ${WH}$ISP" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}City         ${RED}: ${WH}$CITY" | tee -a /etc/vless/akun/log-create-${user}.log
...
echo -e "$RED ${NC} ${WH}http://$domain:89/vless-$user.txt${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}Expired Until   ${RED}: ${WH}$timer Minutes" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ${NC} ${WH}    $author    " | tee -a /etc/vless/akun/log-create-${user}.log
echo -e "$RED ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vless/akun/log-create-${user}.log
echo "" | tee -a /etc/vless/akun/log-create-${user}.log
...
clear
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "$RED ${NC} ${COLBG1}    ${WH}⇱ Limit Vless Account ⇲     ${NC} $RED $NC"
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
clear
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "$RED ${NC}${COLBG1}    ${WH}⇱ Renew Vless Account ⇲      ${NC} $RED $NC"
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "You have no existing clients!"
echo ""
...
if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "$RED ${NC}${COLBG1}    ${WH}⇱ Delete Vless Account ⇲     ${NC} $RED $NC"
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "You have no existing clients!"
echo ""
...
xraylimit
echo -e "$RED╭═════════════════════════════════════════════════╮${NC}"
echo -e "$RED│${NC} ${COLBG1}            ${WH}• VLESS USER ONLINE •              ${NC} $RED│ $NC"
echo -e "$RED╰═════════════════════════════════════════════════╯${NC}"
echo -e "$RED╭═════════════════════════════════════════════════╮${NC}"
...
if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "$RED ${NC}${COLBG1}    ${WH}⇱ Config Vless Account ⇲     ${NC} $RED $NC"
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "You have no existing clients!"
echo ""
...
if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "$RED ${NC}${COLBG1}    ${WH}⇱ Unlock Vless Account ⇲     ${NC} $RED $NC"
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "$RED ${NC}${COLBG1}    ${WH}⇱ Restore Vless Account ⇲    ${NC} $RED $NC"
echo -e "$RED━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
#author=$(cat /etc/profil)
echo -e " $RED╭════════════════════════════════════════════════════╮${NC}"
echo -e " $RED│${NC} ${COLBG1}            ${WH}• VLESS PANEL MENU •                  ${NC} $RED│ $NC"
echo -e " $RED╰════════════════════════════════════════════════════╯${NC}"
echo -e " $RED╭════════════════════════════════════════════════════╮${NC}"
